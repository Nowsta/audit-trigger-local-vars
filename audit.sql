...
BEGIN
    ...
    audit_row = ROW(
        ...
        current_setting('audit.user_id', True),       -- user_id from external system runing query
        current_setting('audit.trace_id', True),      -- trace_id from external system runing query
